...
class LlmSummary
{
    ...
    public function __construct()
    {
        ...
        $this->logger = new \Monolog\Logger('LLMSummary');
        $this->logger->pushHandler($log);
    }

    public function testGetLlmResponse(){
        $input_str = "{'command': 'newLlmSummary', 'assignmentName': '', 'studentQuestion': 'hi'}";
    ...
    public function getLlmResponse($input=null, $course=null){
      ...
      $llm_data = [
        ...
        $result = $this->runScript(\ascillm\Config::$LLM_SUMMARY_SCRIPT, $llm_data, $course);
