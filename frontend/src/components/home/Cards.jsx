    ...
    <div className="row">
      <div className="col-md-4">
        <div className="card p-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-list-ol" viewBox="0 0 16 16" className="card-img-top">
      ...
      <div className="col-md-4">
        <div className="card p-3">
      <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16" class="card-img-top">
      ...
      <div className="col-md-4">
        <div className="card p-3">
      <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-trophy" viewBox="0 0 16 16" className="card-img-top">
