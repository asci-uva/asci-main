...
function GradescopeSync(props) {
  ...
  function getButton(){
    if(disabled)
      ...
      return (
          <button type="button" className="btn btn-primary" onClick={handleSynchronize}>Synchronize Gradescope</button>
        );
  }
  ...
  return (
    ...
    <div className="card">
        <h4 className="card-header">Gradescope Synchronization</h4>
